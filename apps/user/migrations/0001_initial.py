    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('head_portrait', models.ImageField(blank=True, help_text='头像', max_length=200, upload_to='head_portrait/', verbose_name='头像')),
                ('school', models.CharField(blank=True, max_length=20, null=True, verbose_name='学校')),
                ('grade', models.IntegerField(choices=[(1, '大学一年级'), (2, '大学二年级'), (3, '大学三年级'), (4, '大学四年级')], help_text='年级', verbose_name='年级')),
